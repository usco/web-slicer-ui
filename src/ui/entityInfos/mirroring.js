import {div, span, label, button} from '@cycle/dom'
...
const icon = `<svg viewBox="0 0 22 26" version="1.1" preserveAspectRatio="xMidYMid meet"
...
const mirrorXIcon = `<svg viewBox="0 0 24 28" preserveAspectRatio="xMidYMid meet"
...
const mirrorYIcon = `<svg viewBox="0 0 24 28" preserveAspectRatio="xMidYMid meet"
version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <!-- Generator: Sketch 3.8.3 (29802) - http://www.bohemiancoding.com/sketch -->
...
const mirrorZIcon = `<svg viewBox="0 0 24 28" preserveAspectRatio="xMidYMid meet"  preserveAspectRatio='xMinYMin'
 version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <!-- Generator: Sketch 3.8.3 (29802) - http://www.bohemiancoding.com/sketch -->
...
export function renderMirroringUi (state) {
  ...
  const toggled = activeTool === 'mirror'
  const disabled = selections.instIds.length === 0

  const subTools = span([
    withToolTip(
      button('.mirror-x', {attrs: {disabled}}, [Icon(mirrorXIcon)]), 'mirror along x axis', 'right',
   ),
   withToolTip(
     button('.mirror-y', {attrs: {disabled}}, [Icon(mirrorYIcon)]), 'mirror along y axis', 'right',
   ),
   withToolTip(
     button('.mirror-z', {attrs: {disabled}}, [Icon(mirrorZIcon)]), 'mirror along z axis', 'right'
   )

    //Menu({icon: mirrorXIcon, klass: 'mirror-x', tooltip: 'mirror along x axis', tooltipPos: 'right'}),
    //Menu({icon: mirrorYIcon, klass: 'mirror-y', tooltip: 'mirror along y axis', tooltipPos: 'right'}),
    //Menu({icon: mirrorZIcon, klass: 'mirror-z', tooltip: 'mirror along z axis', tooltipPos: 'right'})
  ])

  return Menu({toggled, disabled, icon, klass: 'toMirrorMode', tooltip: 'mirror', tooltipPos: 'right', content: subTools, subItems: true})
}
